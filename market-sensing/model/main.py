...
import numpy as np
import data_input, model, metrics
...
def create_model():
	...
	train, test = model.split_data(data)
	train_x, train_y = model.features_labels(train, features_used)
	test_x, test_y = model.features_labels(test, features_used)
